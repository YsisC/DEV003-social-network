...
const saveTask = (tittle, description, displayName) => {
  const today = new Date();
  ...
  buttonLogin.addEventListener("click", (e) => {
    ...
    functionSignin(email, pasword).then(() => {
      ...
      if (error.code === "auth/invalid-email") {
        ...
        Swal.fire({
          title: "La contrase\xF1a es invalida",
          width: 600,
          padding: "3em",
          color: "#000000f1",
          background: "#fff ",
  ...
  buttonRegister.addEventListener("click", (e) => {
    ...
    functionSignUp(user, email, pasword).then((promiseResult) => {
      ...
      if (error.code === "auth/email-already-in-use") {
        ...
        Swal.fire({
          title: "La contrase\xF1a es debil.",
          width: 600,
          padding: "3em",
          color: "#000000f1",
          background: "#fff ",
...
const Login = (onNavigate2) => {
  ...
  textarea.placeholder = "\xBFQue receta estas pensando?";
